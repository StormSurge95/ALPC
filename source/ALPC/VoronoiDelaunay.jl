...
# Fast, robust 2D Voronoi/Delaunay Tessellation
...
# License: MIT
# Bug reports welcome! https://github.com/JuliaGeometry/VoronoiDelaunay.jl
...
mutable struct DelaunayTriangle{T<:AbstractPoint2D} <: AbstractNegativelyOrientedTriangle
    ...
    # this constructor is for making copies
    function DelaunayTriangle{T}(pa::T, pb::T, pc::T,
